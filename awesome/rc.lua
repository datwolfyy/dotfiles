...
kbdcfg.switch = function ()
    kbdcfg.current = kbdcfg.current % #(tostring(kbdcfg.current)) + 1
...
awesome.connect_signal(
	'startup',
	function(args)
		awful.spawn("polybar example -c ~/.config/polybar/config/config", false)
	end
)
