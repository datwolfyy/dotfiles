...
local theme_path = themes_path .. "purple/"
...
theme.border_color_active = "#852D87"
...
-- Example:
theme.titlebar_bg_normal = theme.bg_focus .. "00"
theme.titlebar_fg_normal = theme.fg_normal
theme.titlebar_bg_focus = theme.bg_normal .. "00"
